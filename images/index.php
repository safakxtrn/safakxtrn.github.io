...
<html>
	  ...
	  gtag('config', 'G-EX095HJFBD');
		...
		<script>
			...
			function popUpSubmit(){
				...
				var url = "https://fieldtech-server.herokuapp.com/api/fieldcad/auth";
				xhr.open('GET', 'https://fieldtech-server.herokuapp.com/api/', true
				);
				...
				xhr.onreadystatechange = function () {
    				if (xhr.readyState != XMLHttpRequest.DONE) {
						alert("Responestext: " + xhr.responseText + "  ENDE");
				...
				xhr.send(null);
				//xhr.send(JSON.stringify({ "username": "hello@user.com", "password": "asdas" }));
    ...
    <body onresize="resizeEvent();" onload="bodyOnLoad();" style="font-family: Arial, Helvetica, sans-serif; min-width: 800px;"> 
		...
		<a onclick="return popUpSubmit()">click here</a> 
		</div>
